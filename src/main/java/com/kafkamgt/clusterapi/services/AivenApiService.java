...
public class AivenApiService {
    ...
    private
    String clusterAccessToken;

    @Value("${klaw.clusters.listacls.api:api}")
    private
    String listAclsApiEndpoint;

    @Value("${klaw.clusters.addacls.api:api}")
    private
    String addAclsApiEndpoint;

    @Value("${klaw.clusters.deleteacls.api:api}")
    private
    String deleteAclsApiEndpoint;

    public Map<String, String> createAcls(MultiValueMap<String, String> permissionsMultiMap) throws Exception {
        ...
        String uri = addAclsApiEndpoint.replace("projectName", projectName)
    ...
    public String deleteAcls(MultiValueMap<String, String> permissionsMultiMap) throws Exception {
        ...
        try {
            ...
            String uri = deleteAclsApiEndpoint.replace("projectName", projectName)
                    .replace("serviceName", serviceName)
                    .replace("aclId", aclId);
    ...
    List<LinkedHashMap<String, String>> listAcls(String projectName, String serviceName) throws Exception {
        RestTemplate restTemplate = getRestTemplate();

        String uri = listAclsApiEndpoint.replace("projectName", projectName)
                .replace("serviceName", serviceName);
        ...
        try {
            ResponseEntity<LinkedHashMap<String, List<LinkedHashMap<String, String>>>> responseEntity = restTemplate.exchange(
