...
public class TopicContentsService {
    ...
    public Map<Long, String> readEvents(String bootStrapServers, String protocol, String clusterName,
                                        String consumerGroupId, String topicName,
                                              int offsetPosition, String readMessagesType){
        log.info("readEvents bootStrapServers {}, protocol {}, clusterName {},  consumerGroupId {},  topicName {},\n" +
                "                                               offsetPosition {},  readMessagesType {}",
                bootStrapServers, protocol, clusterName, consumerGroupId, topicName, offsetPosition, readMessagesType);
    ...
    public KafkaConsumer<String, String> getKafkaConsumer(String groupId, String bootstrapServers, String protocol) {
